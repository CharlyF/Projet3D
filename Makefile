...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4/QtXml -I/usr/include/qt4 -I../../../libQGLViewer-2.5.1/QGLViewer -I/usr/X11R6/include -Itmp
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/X11R6/lib -L/usr/lib/x86_64-linux-gnu -lGLEW -L/home/charly/Bureau/INFSI350/libQGLViewer-2.5.1/QGLViewer/ -lQGLViewer -lGLU -lpthread -lGL -lQtXml -lQtOpenGL -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: raymini.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
		...
		/usr/share/qt4/mkspecs/features/lex.prf \
		/usr/share/qt4/mkspecs/features/include_source_dir.prf \
		/home/charly/Bureau/INFSI350/libQGLViewer-2.5.1/QGLViewer/libQGLViewer.prl \
		/usr/lib/x86_64-linux-gnu/libQtXml.prl \
		/usr/lib/x86_64-linux-gnu/libQtOpenGL.prl \
		/usr/lib/x86_64-linux-gnu/libQtGui.prl \
		/usr/lib/x86_64-linux-gnu/libQtCore.prl
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile raymini.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) tmp/raymini1.0.0/ && $(COPY_FILE) --parents Window.h GLViewer.h QTUtils.h Vertex.h Triangle.h Mesh.h BoundingBox.h Material.h Object.h Light.h Scene.h RayTracer.h Ray.h tmp/raymini1.0.0/ && $(COPY_FILE) --parents Window.cpp GLViewer.cpp QTUtils.cpp Vertex.cpp Triangle.cpp Mesh.cpp BoundingBox.cpp Material.cpp Object.cpp Light.cpp Scene.cpp RayTracer.cpp Ray.cpp Main.cpp tmp/raymini1.0.0/ && (cd `dirname tmp/raymini1.0.0` && $(TAR) raymini1.0.0.tar raymini1.0.0 && $(COMPRESS) raymini1.0.0.tar) && $(MOVE) `dirname tmp/raymini1.0.0`/raymini1.0.0.tar.gz . && $(DEL_FILE) -r tmp/raymini1.0.0
...
tmp/moc_Window.cpp: GLViewer.h \
		...
		QTUtils.h \
		Window.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) Window.h -o tmp/moc_Window.cpp
...
tmp/moc_GLViewer.cpp: Scene.h \
		...
		Light.h \
		GLViewer.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) GLViewer.h -o tmp/moc_GLViewer.cpp

tmp/moc_QTUtils.cpp: QTUtils.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) QTUtils.h -o tmp/moc_QTUtils.cpp
